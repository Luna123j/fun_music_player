...
const Lyrics = () => {
  ...
  useEffect(()=> {
    if (currentSongContent.length !== 0) {
      axios.post('/favourite', {currentSong: currentSongContent[currentSongContent.length-1], username: cookie.username, favorStatus : isFavourite, message: "get initial status"}).then(res => {
